...
struct WantedListResponse: Codable {
    let total: Int
    let wantedPersonList: [WantedPerson]
    let page: Int
}

// MARK: - Response
struct WantedPerson: Codable {
    let datesOfBirthUsed: JSONNull?
    let ageMin: Int
    let path, remarks, eyes, status: String
    let description: String
    let fieldOffices, rewardText: JSONNull?
    let subjects: [String]
    let languages: JSONNull?
    let details: String
    let complexion: JSONNull?
    let posterClassification, sex: String
    let warningMessage, additionalInformation, suspects: JSONNull?
    let weightMax: Int
    let title: String
    let rewardMin: Int
    let publication: String
    let possibleStates: JSONNull?
    let rewardMax: Int
    let nationality: JSONNull?
    let race: String
    let ncic: JSONNull?
    let hair: String
    let caution: JSONNull?
    let images: [Image]
    let aliases, scarsAndMarks: JSONNull?
    let personClassification: String
    let legatNames, occupations: JSONNull?
    let weight, uid: String
    let weightMin: Int
    let locations, possibleCountries, placeOfBirth, build: JSONNull?
    let ageMax: Int
    let ageRange: String
    let heightMax: Int
    let coordinates: [JSONAny]
    ...
    enum CodingKeys: String, CodingKey {
        case datesOfBirthUsed = "dates_of_birth_used"
        case ageMin = "age_min"
        case path, remarks, eyes, status, description
        case fieldOffices = "field_offices"
        case rewardText = "reward_text"
        case subjects, languages, details, complexion
        ...
        case publication
        case possibleStates = "possible_states"
        case rewardMax = "reward_max"
        case nationality, race, ncic, hair, caution, images, aliases
        case scarsAndMarks = "scars_and_marks"
        case personClassification = "person_classification"
        case legatNames = "legat_names"
        case occupations, weight, uid
        case weightMin = "weight_min"
        case locations
        case possibleCountries = "possible_countries"
